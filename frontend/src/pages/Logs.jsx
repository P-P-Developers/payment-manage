...
const LogSkeleton = () => (
  <div className="flex gap-4 animate-pulse">
    ...
    <div className="flex-1 rounded-xl bg-slate-100/40 dark:bg-slate-900/40 border border-slate-300/80 dark:border-slate-800/80 p-4 space-y-3">
      <div className="flex justify-between">
        <div className="h-4 w-24 rounded bg-slate-200 dark:bg-slate-800"></div>
        <div className="h-4 w-32 rounded bg-slate-200/60 dark:bg-slate-800/60"></div>
      </div>
      <div className="h-4 w-full rounded bg-slate-200/80 dark:bg-slate-800/80"></div>
      <div className="h-3 w-4/5 rounded bg-slate-200/40 dark:bg-slate-800/40"></div>
      <div className="flex gap-2 pt-2 border-t border-slate-300/60 dark:border-slate-800/60">
        <div className="h-3.5 w-20 rounded bg-slate-200 dark:bg-slate-800"></div>
            ...
            logs.map((log, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Details box */}
                  <div className="flex-1 min-w-0 rounded-xl bg-slate-100/40 dark:bg-slate-900/40 border border-slate-300/80 dark:border-slate-800/80 p-4 hover:border-slate-300/60 dark:hover:border-slate-700/60 transition-colors">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-500 dark:text-slate-500 uppercase font-bold tracking-wider">{log.module} MODULE</span>
                      </div>
