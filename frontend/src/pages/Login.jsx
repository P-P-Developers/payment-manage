      ...
      <div className="w-full max-w-md rounded-2xl glass-card p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative flex flex-col items-center">
          {logo ? (
            ...
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-500 to-violet-500 text-slate-900 dark:text-white shadow-lg mb-3">
          ...
          {!logo && (
            <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">{orgName}</h2>
          )}
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Digitized ledger & software sales manager</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 py-3 text-sm font-semibold text-slate-900 dark:text-white shadow-lg shadow-indigo-500/20 hover:from-indigo-600 hover:to-violet-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 disabled:opacity-50 transition-all duration-300"
          >
            {loading ? (
