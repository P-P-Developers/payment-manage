...
export default function Panels() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[150] overflow-hidden p-4 flex justify-center items-center !mt-0">
          <div onClick={() => setIsModalOpen(false)} className="fixed inset-0 bg-black/60 backdrop-blur-sm"></div>

          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl glass-card p-6 md:p-8 border border-slate-300 dark:border-slate-800 shadow-2xl z-10 animate-in fade-in zoom-in-95 duration-200 scrollbar-thin">
            <button
