...
export default function Panels() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[150] overflow-y-auto p-4 flex justify-center items-start md:items-center !mt-0">
          <div onClick={() => setIsModalOpen(false)} className="fixed inset-0 bg-black/60 backdrop-blur-sm"></div>

          <div className="relative w-full max-w-2xl rounded-2xl glass-card p-6 md:p-8 border border-slate-300 dark:border-slate-800 shadow-2xl z-10 animate-in fade-in zoom-in-95 duration-200 my-8">
            <button
