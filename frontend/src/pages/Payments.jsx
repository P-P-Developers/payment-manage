...
const SkeletonSpreadsheetRow = () => (
  <tr className="animate-pulse border-b border-slate-800/80">
    <td className="border-r border-slate-700/40 text-center text-slate-500 bg-slate-800/10 py-2.5  w-12">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h2 className="text-2xl  text-white tracking-tight">Ledger Collections (Payments)</h2>
      ...
      {activeTab === 'list' ? (
        <>
          {/* Filters bar */}
          <div className="flex flex-wrap items-center gap-3 w-full bg-slate-900/10 p-2.5 rounded-2xl border border-slate-900/40">
            {/* Search Input */}
            <div className="relative flex-1 min-w-[220px]">
              ...
              <input
                ...
                className="w-full rounded-xl pl-10 pr-4 py-2.5 text-xs glass-input bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-indigo-500/40"
              />
            </div>
            ...
            <div className="shrink-0">
              <select
                ...
                className="rounded-xl px-3 py-2.5 text-xs glass-input bg-slate-950 border border-slate-800 text-slate-300 hover:text-white cursor-pointer transition-all font-semibold"
              >
                <option value="all" className="bg-slate-900">All Transactions</option>
                <option value="bill" className="bg-slate-900">Bills Only</option>
                <option value="received" className="bg-slate-900">Payments Only</option>
              </select>
            </div>

            {/* Date Range Picker */}
            <div className="flex items-center gap-2 bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 shrink-0">
              <input
                type="date"
                value={startDate}
            ...
            <div className="shrink-0">
              <select
                ...
                className="rounded-xl px-3 py-2.5 text-xs glass-input bg-slate-950 border border-slate-800 text-slate-300 hover:text-white cursor-pointer transition-all font-medium"
              >
                <option value="All" className="bg-slate-900">All Charges</option>
                <option value="License" className="bg-slate-900">License</option>
          ...
          <div className="rounded-2xl bg-slate-950/60 border border-slate-800/80 overflow-hidden shadow-2xl backdrop-blur-md">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="bg-slate-900/90 border-b border-slate-800 text-slate-400  uppercase tracking-wider text-[11px]">
                ...
                <tbody className="divide-y divide-slate-800/50 text-slate-300">
                  {loading && payments.length === 0 ? (
                    ...
                    <tr key={p._id} className="hover:bg-slate-900/40 transition-colors duration-150 group">
                      <td className="py-3 px-4 text-center font-mono  text-slate-500 group-hover:text-slate-400">
                      ...
                      <td className="py-3 px-5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className=" text-white tracking-wide">{p.panelId?.panelName || 'Deleted Panel'}</span>
                        </div>
                      </td>
                      <td className="py-3 px-5">
                        <div className="flex flex-col gap-1 items-start">
                          ...
                          {(p.paymentType === 'License' || p.paymentType === 'IP Charges') && (p.quantity !== undefined && p.quantity !== null) && (
                            <span className="text-[9px] text-slate-500  uppercase ml-0.5">Qty: {p.quantity}</span>
                          )}
                        </div>
                      </td>
                      <td className="py-3 px-5">
                      ...
                      <td className="py-3 px-5">
                        <div className="flex items-center gap-1.5 text-slate-300">
                          <div className="h-5 w-5 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center  text-[9px] uppercase border border-slate-700">
                      ...
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700 text-xs  transition-all shadow-md active:scale-95"
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-600 text-indigo-400 hover:text-white border border-indigo-500/10 hover:border-transparent text-xs  transition-all shadow-md active:scale-95"
            ...
            <div className="p-4 bg-slate-900/40 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
              <p className="text-slate-400 font-medium">
                ...
                <span className=" text-white">{totalPaymentsCount}</span> ledger entries
              </p>
        ...
        <div className={`overflow-x-auto p-4 bg-slate-950 rounded-2xl border border-slate-800 shadow-xl transition-all duration-300 ${isFullscreen ? 'fixed inset-0 z-[100] p-6 overflow-auto bg-slate-950' : ''}`}>
          <div className="flex items-center justify-between mb-4 text-xs font-mono border-b border-slate-800 pb-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-400 ">Consolidated Panels Ledger Sheet</span>
              <button
                onClick={() => setIsFullscreen(!isFullscreen)}
                className="flex items-center gap-1.5 px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700  text-[11px] transition-all shadow-md active:scale-95"
          ...
          <table className="w-full text-left border border-slate-700/60 font-mono text-[13px] md:text-sm border-collapse bg-slate-900/40">
            ...
            <tbody>
              {panels.map((p, idx) => (
                <tr key={p._id} className="contents">
                  ...
                  >
                    ...
                    <td className="border-r border-slate-700/40 px-4 py-2.5 text-white ">
                      {p.panelName}
                    </td>
                    <td className="border-r border-slate-700/40 px-4 py-2.5 text-slate-200 ">
                      {p.ownerName}
                    </td>
                    <td className="border-r border-slate-700/40 px-4 py-2.5 text-right text-slate-100 ">
                  ...
                  {expandedPanelId === p._id && (
                    <tr className="bg-slate-950/40 border-b border-slate-800/80">
                      <td className="border-r border-slate-700/40 text-center text-slate-500 bg-slate-950/20 py-4 ">
                        ↳
                      </td>
                                ...
                                <tbody>
                                  {getLast30DaysData(expandedPanelPayments).map((row, hIdx) => (
                                    ...
                                    >
                                      ...
                                      <td
                                        className={`border-r border-slate-700/40 px-3 py-1.5 text-right  ${row.billAmount > 0 ? 'text-amber-400 bg-amber-400/5' : 'text-slate-500'} ${row.hasData ? 'cursor-pointer hover:bg-slate-800/40 hover:text-white group' : ''}`}
                                      ...
                                      >
                                        {editingCell && editingCell.paymentId === row.originalPayment?._id && editingCell.field === 'billAmount' ? (
                                          <input
                                            type="number"
                                            className="w-20 bg-slate-950 border border-indigo-500 rounded px-1 text-right text-xs text-indigo-300 font-mono  focus:outline-none"
                                            value={editingCell.value}
                                            onChange={(e) => setEditingCell({ ...editingCell, value: e.target.value })}
                                      ...
                                      >
                                        {editingCell && editingCell.paymentId === row.originalPayment?._id && editingCell.field === 'amountReceived' ? (
                                          <input
                                            type="number"
                                            className="w-20 bg-slate-950 border border-emerald-500 rounded px-1 text-right text-xs text-emerald-300 font-mono  focus:outline-none"
                                            value={editingCell.value}
                                            onChange={(e) => setEditingCell({ ...editingCell, value: e.target.value })}
                                  ...
                                  <tr className="bg-slate-900 border-t border-slate-800  text-white text-[11px]">
              ...
              {/* Excel Summary Row */}
              <tr className="bg-slate-800/80 border-t-2 border-slate-700  text-white text-xs">
                ...
                {modalMode === 'receive' ? (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl px-4 py-3 text-sm glass-input  text-white text-base"
                      min="1"
                      required
                    />
                  </div>
              ...
              {selectedPanelDetails && (
                <div className="rounded-xl bg-slate-900/60 p-4 border border-slate-800 flex items-center justify-between text-xs">
                  <div>
                    ...
                    <p className=" text-white text-sm mt-0.5">{selectedPanelDetails.ownerName}</p>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-xl px-3.5 py-2.5 text-xs glass-input text-white "
                            required
                            min="0"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <div className="w-full rounded-xl px-3.5 py-2.5 text-xs bg-slate-900 border border-slate-800 text-emerald-400  flex items-center justify-between">
                            <span>₹</span>
              ...
              <div className="bg-slate-900/40 border border-slate-800/80 rounded-xl p-4 space-y-3.5">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <span className=" text-white text-sm">{viewingPayment.panelId?.panelName || 'N/A'}</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block mb-1">Owner Name</span>
                    <span className=" text-white text-sm">{viewingPayment.panelId?.ownerName || 'N/A'}</span>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-xs">
                  ...
                  {viewingPayment.billAmount > 0 && (
                    <>
                      <div>
                        ...
                        <span className=" text-white font-mono">{viewingPayment.quantity !== undefined && viewingPayment.quantity !== null ? viewingPayment.quantity : 1}</span>
                      </div>
                      <div>
                        <span className="text-slate-400 block mb-1">Unit Price</span>
                        <span className=" text-white font-mono">₹{viewingPayment.unitPrice?.toLocaleString() || '0'}</span>
                      </div>
                      <div>
                  ...
                  {viewingPayment.amountReceived > 0 && (
                    <div>
                      ...
                      <span className=" text-slate-200">{viewingPayment.amountReceived > 0 ? viewingPayment.paymentMode : '-'}</span>
                    </div>)}
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className=" text-white">{viewingPayment.addedBy?.name || 'Staff User'}</span>
            ...
            <form onSubmit={handleUpdatePayment} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-200 focus:outline-none focus:border-indigo-500 cursor-pointer font-semibold"
                  required
                />
              </div>
                  ...
                  {(editForm.paymentType === 'License' || editForm.paymentType === 'IP Charges') && (
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="w-full bg-slate-900/50 border border-slate-800/50 rounded-xl px-4 py-2.5 text-sm  font-mono text-indigo-400">
